...
import NarratePage from './pages/Narrate';
...
import UIAnglePage from './pages/UIAngle';
import CameraStudio from '@/pages/CameraStudio';
import KaChatPage from '@/pages/KaChat';
...
import KaspaKidsAcademyPage from './pages/KaspaKidsAcademy';
...
import SlobzMarketPage from './pages/SlobzMarket';
import SlobzAnimationsPage from './pages/SlobzAnimations';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/UI/Angle" element={<UIAnglePage />} />
      ...
      <Route path="/KaspaKidsAcademy" element={<KaspaKidsAcademyPage />} />
      ...
      <Route path="/SlobzMarket" element={<SlobzMarketPage />} />
      <Route path="/SlobzAnimations" element={<SlobzAnimationsPage />} />
