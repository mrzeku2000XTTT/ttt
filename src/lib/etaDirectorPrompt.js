...
Cards variants: build a Fibonacci-sphere satellite composition and provide centerHeadline, cardColor, cardRadius, cardWidth, cardHeight, cardFont, cardFontSize, cardFontWeight, cardTextDepth, textTransform, spinPeriodFrames, spinSpeed, sphereRadius, sphereTiltX, sphereTiltZ, headlineOrbitRadius, headlineOrbitSpeed, headlineOrbitIncline, spinDirection, cardPerspective, satelliteX/Y/Z, satelliteRotateX/Y/Z, spinPhase, and 2–4 ringKeyframes with changing speed/radius/tilt/depth.
PhoneWindow/IPhoneAnimated: provide a valid phoneModel and describe believable screen content in visual/subtitle. SearchAnimation: provide searchText. UIAnimation: pageTitle, pageSubtitle, ctaLabel, and browserRows describing the dashboard modules.
