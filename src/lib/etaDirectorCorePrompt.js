...
Every scene requires component, purpose, duration, headline, voiceover, visual, motion, transition, hyperframe_animation, and advanced. Voiceover carries narrative. Visual describes only visible action. On-screen copy is short and intentional, with no instructional clutter. Natural-language requests for mobile experiences must become bespoke phoneHtml interfaces whose structure, content, and ordered frame-driven reveals visibly enact that exact request; never substitute a generic reusable phone mockup.
