          ...
          >
            ...
            {user ? (
              ...
              <button
                onClick={() => {
                  setShowMenu(false);
                  // Replace the page with a branded Kaspa-logo loading screen, identical
                  // to the boot overlay in index.html, then redirect. The matching overlay
                  // on /login keeps the same logo on screen so the transition is seamless
                  // and the user never sees the unstyled page-list flash.
