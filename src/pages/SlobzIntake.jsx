...
export default function SlobzIntake() {
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <AnimatePresence mode="wait">
          {!result && !isProcessing && !error && (
            <motion.div key="intake" exit={{ opacity: 0 }} className="pt-4">
              <div className="text-center mb-8">
                <h1 className="font-display text-3xl md:text-4xl font-black text-[#4A2FA8]">The Chaos Intake</h1>
                <p className="text-sm text-[#5A4B8A] mt-2">The SAE engine turns your mess into a career plan.</p>
              </div>
          ...
          {isProcessing && (
            <motion.div key="processing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-12">
              <div className="bg-[#FDFBF7] rounded-[28px] shadow-[0_16px_40px_rgba(124,92,252,0.18)] p-12 md:p-16 text-center">
          ...
          {error && !isProcessing && (
            <motion.div key="error" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-12">
              <div className="bg-[#FDFBF7] rounded-[28px] shadow-[0_16px_40px_rgba(124,92,252,0.18)] p-10 text-center">
          ...
          {result && !isProcessing && (
            <motion.div key="results" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-5 pt-4">
