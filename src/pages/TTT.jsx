...
export default function TTTPage() {
  ...
  const apps = [
    ...
    { name: "Arh'tuun", path: "Arhtuun", category: "AI", defaultIcon: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6901295fa9bcfaa0f5ba2c2a/af9093f96_image.png" }
  ];
