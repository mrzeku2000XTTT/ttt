...
export default function TTTPage() {
  ...
  const apps = [
    ...
    { name: "VibeWallet", path: "VibeWallet", category: "Finance", defaultIcon: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6901295fa9bcfaa0f5ba2c2a/9564723cd_IMG_0959.png" }
  ];
