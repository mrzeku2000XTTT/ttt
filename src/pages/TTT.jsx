...
export default function TTTPage() {
  ...
  const apps = [
    ...
    { name: "VibeWallet", path: "VibeWallet", category: "Finance", defaultIcon: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6901295fa9bcfaa0f5ba2c2a/f12be76ff_917DCBBE-5E2C-48AE-98CE-2E10DFA61973.png" }
  ];
