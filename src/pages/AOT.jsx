...
export default function AOTPage() {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-4">AoT Tribute Game</h1>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 rounded-lg flex items-center justify-center">
                <Lock className="w-5 h-5 text-red-400" />
              </div>
              <div>
                <h3 className="text-white font-bold text-lg">Unlock AoT Game</h3>
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 h-12 text-white font-bold"
            >
              {kaswareWallet.connected ? (
                <>
            ...
            >
              ...
              >
                ...
                <p className="text-white/60 text-sm mb-6">
                  Send KAS to yourself to unlock AoT Game
                </p>
  ...
  return (
    <div className="fixed inset-0 bg-black">
      <div className="absolute top-0 left-0 right-0 z-10 bg-black/80 backdrop-blur-sm border-b border-red-500/20 p-3 flex items-center justify-between">
        <Link to={createPageUrl("AppStore")}>
        ...
        <h1 className="text-white font-bold text-lg">AoT Tribute Game</h1>
        <div className="w-20" />
      </div>

      <iframe
        src="https://aottg2.com"
        className="w-full h-full"
        style={{ border: 'none' }}
        title="AoT Tribute Game"
