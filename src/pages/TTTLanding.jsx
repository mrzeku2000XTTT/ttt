    ...
    <main className="relative min-h-screen overflow-hidden bg-white text-slate-950">
      ...
      >
        <img
          ...
          className="h-full w-full scale-90 object-contain object-center opacity-100 [image-rendering:auto] transform-gpu brightness-75 contrast-125 saturate-125 md:scale-[0.78]"
        />
      </motion.div>
      <img
        src={ORB_IMAGE}
