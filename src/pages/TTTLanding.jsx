...
const CORNER_ART = "https://media.base44.com/images/public/6901295fa9bcfaa0f5ba2c2a/a5a863d85_generated_image.png";
...
export default function TTTLandingPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-white text-slate-950">
      ...
      <img src={CORNER_ART} alt="TTT corner art" className="pointer-events-none absolute left-0 top-0 h-52 w-52 object-contain opacity-55 sm:h-72 sm:w-72" />
      <img src={CORNER_ART} alt="TTT corner art" className="pointer-events-none absolute right-0 top-0 h-52 w-52 scale-x-[-1] object-contain opacity-55 sm:h-72 sm:w-72" />
      <img src={CORNER_ART} alt="TTT corner art" className="pointer-events-none absolute bottom-0 left-0 h-52 w-52 scale-y-[-1] object-contain opacity-45 sm:h-72 sm:w-72" />
      <img src={CORNER_ART} alt="TTT corner art" className="pointer-events-none absolute bottom-0 right-0 h-52 w-52 scale-[-1] object-contain opacity-45 sm:h-72 sm:w-72" />
      <img
        src={ORB_IMAGE}
