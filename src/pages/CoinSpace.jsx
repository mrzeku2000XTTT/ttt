...
export default function CoinSpacePage() {
  return (
    <div className="h-[calc(100vh-8rem)] bg-zinc-950 text-white flex flex-col">
      {/* Header */}
      <div className="px-4 py-2 flex items-center justify-between border-b border-white/10 bg-black/50 backdrop-blur-xl sticky top-0 z-50 shrink-0">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl w-full text-center space-y-4">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center shadow-xl shadow-orange-500/20">
            ...
            >
              <Button className="w-full sm:w-auto px-6 py-4 text-base font-bold bg-white text-black hover:bg-zinc-200 rounded-full shadow-lg shadow-white/10 transition-all hover:scale-105">
                Launch Wallet
