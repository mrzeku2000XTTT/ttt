...
import { ArrowLeft, Zap, Radio, Waves, SignalLow, Timer, BrainCircuit, Lightbulb } from "lucide-react";
import { Link } from "react-router-dom";
import { createPageUrl } from "@/utils";
import { base44 } from "@/api/base44Client";
import SpeedImageGen from "@/components/SpeedImageGen";
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs mt-0.5">{tab === "network" ? "Network Performance Test" : "AI Image Generator"}</p>
            </div>
          </div>
        </div>
