...
export default function BRAHIMHubPage() {
  const apps = [
    {
      name: "Kasconnect",
      icon: Link2,
      path: "BRAHIM",
      description: "Connect with Kasware",
    ...
    },
    {
      ...
      icon: BookOpen,
      path: "KASBOOKS",
      description: "Kaspa Books Platform",
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6">
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        >
          <img 
            src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6901295fa9bcfaa0f5ba2c2a/88322e438_image.png"
            alt="BRAHIM Logo"
