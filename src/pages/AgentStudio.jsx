...
import AgentStudioLanding from "@/components/agentstudio/AgentStudioLanding";
...
export default function AgentStudioPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      {view !== "landing" && (
        <div className="sticky top-0 z-40 bg-[#fafafa]/85 backdrop-blur-xl border-b border-zinc-200/70">
          <div className="max-w-5xl mx-auto px-4 sm:px-5 h-14 flex items-center justify-between">
            <button onClick={() => setView("landing")} className="text-base font-bold text-zinc-900 tracking-tight hover:text-cyan-600 transition-colors" title="Back to Agent Studio landing">
              TTT
            </button>
      ...
      {view === "landing" ? (
        <AgentStudioLanding onEnter={() => setView("dashboard")} onNew={createAgent} />
      ) : view === "dashboard" ? (
        <>
          <AgentStudioHero />
