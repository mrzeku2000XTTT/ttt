  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        {/* Launch button */}
        <button
          onClick={() => { window.location.href = KASSIGNER_APP_URL; }}
          className="flex items-center justify-center w-full h-24 rounded-3xl bg-cyan-500 hover:bg-cyan-400 text-black font-black text-2xl sm:text-3xl transition-all shadow-[0_0_40px_rgba(6,182,212,0.5)] hover:shadow-[0_0_60px_rgba(6,182,212,0.7)] hover:scale-[1.02] mb-3"
        >
          Open KasSigner →
        </button>
        <p className="text-xs text-white/40 text-center mb-8">
          Opens the KasSigner app. Works on any phone's browser.
        </p>
