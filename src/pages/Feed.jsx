...
import {
  ...
  Loader2, Image as ImageIcon, X, Sparkles, Eye, Users, Activity, Video, FileText, DollarSign, Wallet as WalletIcon, Plus, CornerDownRight, Pencil, Share, AlertCircle, Palette, Trophy, Hammer, Search, CircleDot, Newspaper, Box, Moon, Brain, ChevronDown, CheckCircle2
} from "lucide-react";
              ...
              <div className="space-y-3">
                ...
                <AnimatePresence>
                  {showManualAddressInput && (
                    ...
                    >
                      <div>
                        <label className="text-xs text-white/60 mb-2 block">Your Kaspa Address (for receiving tips)</label>
                        <Input
