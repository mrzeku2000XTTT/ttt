  ...
  return <main className="min-h-screen bg-zinc-950 px-5 py-16 text-white">
    ...
    <div className="mx-auto max-w-3xl">
      <div className="flex items-center gap-4">
        <img src="https://raw.githubusercontent.com/Curious-being99/Kaspa-browser-/v1.0.20260913223625/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.webp" alt="Kaspa Browser" className="h-20 w-20 rounded-2xl" />
