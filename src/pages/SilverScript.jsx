...
const EXAMPLES = [
  ...
  {
    title: "Token Covenant",
    description: "Native asset management with state transitions on L1",
    code: `contract TokenCovenant(bytes20 tokenId, int supply) {
  function transfer(pubkey from, pubkey to, int amount) {
    require(checkSig(from));
    require(amount > 0 && amount <= supply);
    // State persists in UTXO output
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(ellipse at 20% 50%, rgba(6,182,212,0.08) 0%, transparent 60%), 
                            radial-gradient(ellipse at 80% 20%, rgba(148,163,184,0.06) 0%, transparent 50%)`
        }} />
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-16">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-cyan-500/10 border border-cyan-500/30 rounded-full text-cyan-400 text-xs font-semibold mb-4">
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8">
              ...
              Write DeFi vaults, native asset management, and covenants directly on <span className="text-cyan-400">Kaspa L1</span>.
            </p>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <a
                href="https://github.com/kaspanet/silverscript/blob/master/TUTORIAL.md"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-3">
              ...
              <pre className="bg-black/60 border border-white/10 rounded-lg p-3 text-xs text-green-400 font-mono overflow-x-auto">
{`# Clone the repo
...
{`cargo run -p cli-debugger -- \\
  ...
  --ctor-arg 3 --arg 1`}
        ...
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <h2 className="text-2xl font-bold text-white mb-6">Where it fits in Kaspa's Roadmap</h2>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="space-y-4">
              {[
                ...
                { layer: "Execution", name: "vProgs", desc: "Shared state / L2 node framework (Hans Moog)", color: "blue" },
              ].map((item, i) => (
                <div key={i} className={`flex items-start gap-4 p-4 rounded-lg border ${item.active ? 'bg-cyan-500/5 border-cyan-500/20' : 'bg-white/3 border-white/10'}`}>
                  <div className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider flex-shrink-0 mt-0.5 ${
            ...
            <div className="mt-4 text-center text-white/40 text-xs">
              🎯 Target: <span className="text-white/60 font-semibold">May 5, 2026 Covenant Hardfork</span>
            </div>
          </div>
        </motion.section>
