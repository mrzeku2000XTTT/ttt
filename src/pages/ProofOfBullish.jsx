        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            {proofs.filter(p => p.media_type === 'video').length > 0 && (
              <div
                className="relative cursor-pointer group active:scale-95 transition-transform inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-lg font-medium"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  const videos = proofs.filter(p => p.media_type === 'video');
