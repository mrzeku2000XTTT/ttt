...
export default function AppStorePage() {
  ...
  const apps = [
    ...
    { name: "StakeDAG", icon: "TrendingUp", path: "StakeDAG", category: "Games", defaultIcon: "https://media.base44.com/images/public/6901295fa9bcfaa0f5ba2c2a/2c211776c_generated_image.png" },
      ];
