...
export default function AppStorePage() {
  ...
  const apps = [
    ...
    { name: "Keystone", icon: "Link2", path: "Keystone", category: "Tools", defaultIcon: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6901295fa9bcfaa0f5ba2c2a/546250374_image.png", circular: true },
    ];
