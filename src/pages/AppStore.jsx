...
export default function AppStorePage() {
  ...
  const apps = [
    ...
    { name: "RufzeitK", icon: "Link2", path: "RufzeitKHome", category: "Communication", defaultIcon: "https://ui-avatars.com/api/?name=RK&size=128&background=06b6d4&color=000&bold=true", circular: true },
    ];
