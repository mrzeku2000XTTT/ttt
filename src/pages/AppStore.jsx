...
export default function AppStorePage() {
  ...
  const apps = [
    { name: "APEX", icon: "Link2", path: "APEX", category: "Security", defaultIcon: "https://media.base44.com/images/public/6901295fa9bcfaa0f5ba2c2a/de2e1af61_generated_image.png" },
