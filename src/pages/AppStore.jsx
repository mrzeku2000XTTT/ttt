...
export default function AppStorePage() {
  ...
  const apps = [
    ...
    { name: "StakeDAG", icon: "TrendingUp", path: "StakeDAG", category: "Games", defaultIcon: "https://ui-avatars.com/api/?name=SD&size=128&background=059669&color=fff&bold=true" },
      ];
