...
import { ArrowRight, Store, SplitSquareHorizontal, Move3d, Sparkles } from 'lucide-react';

const HERO = 'https://media.base44.com/images/public/6901295fa9bcfaa0f5ba2c2a/4d239dd68_generated_image.png';
    ...
    <div className="min-h-screen bg-[#070707] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-5 sm:px-6 py-16 sm:py-24 text-center">
          ...
          <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-2">
            <Link
              to="/MorphStudio"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full bg-white text-black text-xs font-bold hover:opacity-90 transition-opacity"
            >
              Open the studio <ArrowRight className="w-3.5 h-3.5" />
            </Link>
            <Link
              to="/AppStoreV2"
      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-6 pb-16">
        ...
        <div className="mt-3 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-center">
          ...
          <Link
            to="/MorphStudio"
            className="mt-4 inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-white text-black text-xs font-bold hover:opacity-90 transition-opacity"
          >
