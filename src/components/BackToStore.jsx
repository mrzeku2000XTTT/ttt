 ...
 */
const HIDDEN_PATHS = ["/AppStoreV2", "/AppStore", "/", "/TTTHome", "/TTTGate", "/KaspaCollab", "/CollabCollaborators", "/Kanvas", "/CAM", "/Biblia", "/ClutchKAS", "/KaChat", "/FlagSense", "/Hybrid", "/Morph", "/MorphStudio"];
