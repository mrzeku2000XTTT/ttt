      ...
      <div className="flex items-center justify-between">
        ...
        {wallet && (
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-full border border-white/15 bg-white/[0.06] text-white/60 transition-colors hover:text-white active:scale-95 disabled:opacity-40"
          >
      ...
      {!wallet ? (
        <>
          ...
          <button
            ...
            className="flex h-9 w-full items-center justify-center gap-2 rounded-xl bg-cyan-500 text-sm font-bold text-black transition-transform active:scale-95 disabled:opacity-40"
          >
        ...
        <>
          ...
          <div>
            <p className="mb-1 text-[11px] uppercase tracking-wider text-white/35">Scorpion wallet address</p>
