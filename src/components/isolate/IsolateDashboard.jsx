...
import { ArrowLeft, Plus, Flame, BookOpen, Clock } from "lucide-react";
...
export default function IsolateDashboard({ user, courses, loading, onNewCourse, onOpenCourse, onBack }) {
