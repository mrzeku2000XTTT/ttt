      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative flex items-center gap-2 px-4 h-14 sm:h-16 rounded-full border border-white/15 bg-black/70 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] focus-within:border-white/30 transition-all">
          ...
          {!focused && userValue.length === 0 && (
            <span className="absolute left-11 right-24 sm:right-28 top-1/2 -translate-y-1/2 overflow-hidden text-white/55 font-mono text-sm sm:text-base leading-none pointer-events-none z-0 flex items-center">
              ...
              <motion.span
                ...
                className="inline-block w-[2px] h-[1.05em] bg-white/60 ml-0.5 shrink-0"
              />
            </span>
          )}
          ...
          <button
            ...
            className="relative z-10 shrink-0 flex items-center gap-1.5 px-3 h-9 rounded-xl border border-white/15 bg-white/10 text-white text-[10px] font-bold tracking-widest uppercase disabled:opacity-30 enabled:hover:bg-white/20 transition-colors"
          >
