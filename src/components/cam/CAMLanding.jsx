...
export default function CAMLanding({ onConnect, onEnter, loading, error, hasWallet, onExit }) {
  return (
    <section className="cm-page relative grid min-h-screen items-center lg:grid-cols-2">
      <button onClick={onExit} className="absolute right-6 top-6 z-30 text-[10px] uppercase tracking-[0.25em] text-[hsl(var(--cm-muted))] transition hover:text-white">Exit to Store</button>
