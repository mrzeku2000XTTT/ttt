...
import ETAPhoneHTML from './ETAPhoneHTML';
...
export default function ETAPhoneStoryScene({ scene, advanced, frameProgress }) {
  return <div className="absolute inset-[3px] overflow-hidden rounded-[2.45rem] border border-white/25 bg-[#08090b] text-[#f5f5f7] shadow-[inset_0_0_0_1px_rgba(255,255,255,.08)]">
    ...
    {!advanced.screenMedia?.url && advanced.phoneHtml && <ETAPhoneHTML html={advanced.phoneHtml} frameProgress={frameProgress} />}
    {!advanced.screenMedia?.url && !advanced.phoneHtml && <div className="relative flex h-full flex-col overflow-hidden px-[7%] pb-[5%] pt-[17%]">
