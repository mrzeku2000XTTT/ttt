...
- "verify_task": the user submits PROOF (usually a screenshot) that they completed a K-CREDITS earn task. Valid task ids: "follow_x" (they follow @Mrzeku2000x on X), "post_x" (they posted about AGENT. on X and tagged @Mrzeku2000x). Analyze the attached proof image STRICTLY — set "task_approved" true ONLY if the image clearly shows the task completed; false otherwise (no image attached = false). action_input = the task id.
