    ...
    >
      <div className="flex items-center gap-3 pl-1">
        ...
        <div className="hidden sm:block">
          <p className="text-xs font-semibold uppercase tracking-[0.32em] text-white/45">TTT Portal</p>
          <p className="text-sm text-white/75">Enter the original landing experience</p>
        </div>
      </div>
