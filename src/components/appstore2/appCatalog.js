...
export const APPS = [
  ...
  { name: "Kaspa Browser", path: "KaspaBrowser", cat: "Kaspa", logo: "https://raw.githubusercontent.com/Curious-being99/Kaspa-browser-/v1.0.20260913223625/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.webp", repoUrl: "https://github.com/Curious-being99/Kaspa-browser-", releaseUrl: "https://github.com/Curious-being99/Kaspa-browser-/releases/tag/v1.0.20260913223625", downloadUrl: "https://github.com/Curious-being99/Kaspa-browser-/releases/download/v1.0.20260913223625/KaspaBrowser-release-signed.apk", desc: "Decentralized Android browser · Chromium, mesh discovery, privacy controls, cryptographic identity & native Kaspa wallet tools", maturity: 80 },
  { name: "ETA", path: "ETA", cat: "Creative", desc: "Enhanced Timeline Animator · product brief to an editable AI-directed scene plan with motion, pacing, voiceover, and transitions", maturity: 70 },
