...
export default function KaspaComModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-cyan-500/20 flex-shrink-0 bg-black/80 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-bold text-lg">KaspaCom</h3>
              <p className="text-white/60 text-xs">Kaspa Wallet</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Button
